...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '查询账户余额', description: '企业管理员查询本企业账户余额' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '修改账户状态', description: '平台管理员冻结/解冻账户' }),
    ...
    __metadata("design:returntype", Promise)
], AccountController.prototype, "changeStatus", null);
